...
import com.isaque.ufc.app.tela.TelaUsuario;
        ...
        try {
            ...
            while (true) {
                ...
                if (info.equals("1")) { 
                    ...
                    JOptionPane.showMessageDialog(TelaUsuario.window, "Alguém já está conectado com um mesmo Ip ou nome");
                    break;
                }
            ...
            JOptionPane.showMessageDialog(TelaUsuario.window, "Você se desconectou!");
        }
    }
}
